...
export class WhatsAppController {
        ...
        if (typeof Notification === 'function') {
            ...
            this.el.alertNotificationPermission.on('click', e => {
                Notification.requestPermission(permission => {
                    if (permission === 'granted') this.el.alertNotificationPermission.hide();
                });
            });
        }
    }
            ...
            .then((response) => {
                ...
                this._user.on('datachange', data => {
                    ...
                    if (data.photo) {
                        ...
                        let photoThumb = this.el.myPhoto.querySelector('img');
                        photoThumb.src = data.photo;
                        photoThumb.show();
                    }
    ...
    initEvents() {
        ...
        this.el.btnSavePanelEditProfile.on('click', e => {
            ...
            this.el.btnSavePanelEditProfile.hide();
            this._user.name = this.el.inputNamePanelEditProfile.innerHTML;

            this._user.save().then(() => {
                this.el.btnSavePanelEditProfile.show();
            });
        });
        ...
        this.el.btnSendMicrophone.on('click', e => {
            ...
            this._microphoneController.on('ready', voice => {
    ...
    setActiveChat(contact) {
        ...
        if (this._contactActive) Message.getRef(this._contactActive.chatId).onSnapshot(() => {});
        ...
        Message.getRef(this._contactActive.chatId).orderBy('timeStamp').onSnapshot(docs => {
            ...
            docs.forEach(doc => {
                ...
                let myMsg = (data.from === this._user.email);
                let view = message.getViewElement(myMsg);

                if (!myMsg && this._messagesReceived.filter(id => {
                        return (id === data.id)
                    }).length === 0) {
                ...
                if (this.el.panelMessagesContainer.querySelector('#_' + data.id) && myMsg) {
                    let msgEl = this.el.panelMessagesContainer.querySelector('#_' + data.id);
